# Merxet -- Scan. Shop. Pay in a flash.
...
- Combines **QR scanning** with **Hedera smart contract payments**
...
- **No servers, no databases, no logins** — just a client-side app + the **Hedera blockchain**.
