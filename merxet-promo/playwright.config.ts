...
export default defineConfig({
  ...
  webServer: [
    ...
    {command: 'npm run build:storefront -- --base=/s/template/ --outDir=dist-storefront && npm run preview -- --host 127.0.0.1 --port 4174 --strictPort --outDir=dist-storefront --base=/s/template/', url: 'http://127.0.0.1:4174/s/template/', reuseExistingServer: false, timeout: 120_000},
  ],
});
